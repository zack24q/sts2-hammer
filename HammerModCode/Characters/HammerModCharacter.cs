...
public sealed class HammerModCharacter : ModCharacterTemplate<HammerModCardPool, HammerModRelicPool, HammerModPotionPool>
{
    ...
    public override CharacterAssetProfile AssetProfile => new(
        ...
        Ui: new CharacterUiAssetSet(
            IconTexturePath: $"{ImageRoot}/HammerMod_character_icon.png",
            IconOutlineTexturePath: $"{ImageRoot}/HammerMod_character_icon_outline.png",
            CharacterSelectBgPath: CharacterSelectBgScenePath,
            CharacterSelectIconPath: $"{ImageRoot}/HammerMod_character_select.png",
            CharacterSelectLockedIconPath: $"{ImageRoot}/HammerMod_character_select_locked.png",
            MapMarkerPath: $"{ImageRoot}/HammerMod_map_marker.png"));
